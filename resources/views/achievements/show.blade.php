<x-app-layout>
    ...
    @else
    <div class="bg-yellow-100 text-gray-700 p-6 rounded-xl shadow-md text-lg">感想、関連URLが存在しません。</div>
    @endif

    <a href="/achievement" class="text-blue-600 underline mt-10 inline-block hover:text-blue-800 transition text-lg">達成リストに戻る</a>
</x-app-layout>